            ...
            >
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="lg:w-1/2">
                  <div className="h-64 sm:h-80 lg:h-96 bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                ...
                <div className="lg:w-1/2 p-6 sm:p-8 flex flex-col justify-center">
                  ...
                  <a 
                    href="#enroll" 
                    className="inline-block w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 text-base sm:text-lg text-center"
                  >
                    立即報名
                  </a>
                </div>
